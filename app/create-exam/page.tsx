...
export default function CreateExamPage() {
  ...
  const handleSaveExam = async () => {
    ...
    if (questions.length === 0) {
      setErrorMessage('Please add at least one question before publishing the exam.');
      setIsSaving(false);
      return;
    }
    ...
    try {
      ...
      setSuccessMessage('Exam published successfully! Redirecting to dashboard...');
      setTimeout(() => {
        ...
        <div className="grid grid-cols-3 gap-6">
          ...
          <div className="col-span-2 space-y-6">
            ...
            <div className="flex gap-4">
              ...
              >
                {isSaving ? 'Publishing...' : 'Save & Publish Exam'}
              </Button>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md sticky top-6 space-y-4">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between text-blue-600">
                  <span className="font-medium">Questions Marks:</span>
                  <span className="font-medium">{calculateCurrentTotalMarks()} / {totalMarks}</span>
                </div>

                {calculateCurrentTotalMarks() !== parseInt(totalMarks) && (
                  <p className="text-amber-600 text-xs mt-2">
                    Warning: Question marks don&apos;t match total marks
                  </p>
                )}
              </div>
            </div>
